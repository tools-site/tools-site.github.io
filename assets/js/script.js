...
(function ($, window, undefined) {
  ...
  $(document).ready(function () {
    ...
    $("a.smooth").click(function (ev) {
      ev.preventDefault();
      if ($("#main-menu").hasClass("mobile-is-visible") != true) return;
    ...
    $('a[data-toggle="mobile-menu-both"]').on("click", function (ev) {
      ...
      public_vars.$horizontalMenu.toggleClass(
        "mobile-is-visible both-menus-visible"
      );
    });
    ...
    $('a[data-toggle="user-info-menu-horizontal"]').on("click", function (ev) {
      ev.preventDefault();
      public_vars.$userInfoMenuHor
        .find(".nav.nav-userinfo")
        .toggleClass("mobile-is-visible");
    });
    // Panel Close
    ...
    $("[data-loading-text]").each(function (
      i,
      el // Temporary for demo purpose only
    ) {
      var $this = $(el);
...
(function ($, window, undefined) {
  ...
  $(document).ready(function () {
    ...
    public_vars.$sidebarProfile =
      public_vars.$sidebarMenu.find(".sidebar-user-info");
    public_vars.$mainMenu = public_vars.$sidebarMenu.find(".main-menu");
    public_vars.$horizontalNavbar = public_vars.$body.find(
      ".navbar.horizontal-menu"
    );
    public_vars.$horizontalMenu =
      public_vars.$horizontalNavbar.find(".navbar-nav");
    public_vars.$mainContent = public_vars.$pageContainer.find(".main-content");
    public_vars.$mainFooter = public_vars.$body.find("footer.main-footer");
    public_vars.$userInfoMenuHor = public_vars.$body.find(
      ".navbar.horizontal-menu"
    );
    public_vars.$userInfoMenu = public_vars.$body.find(
      "nav.navbar.user-info-navbar"
    );
    public_vars.$settingsPane = public_vars.$body.find(".settings-pane");
    public_vars.$settingsPaneIn = public_vars.$settingsPane.find(
      ".settings-pane-inner"
    );
    public_vars.wheelPropagation = true; // used in Main menu (sidebar)
    public_vars.$pageLoadingOverlay = public_vars.$body.find(
...
function setup_sidebar_menu() {
  if (public_vars.$sidebarMenu.length) {
    ...
    if (
      is("largescreen") &&
      public_vars.$sidebarMenu.hasClass("collapsed") == false
    ) {
...
function sidebar_menu_item_expand($li, $sub) {
  if (
    ...
    ($li.parent(".main-menu").length &&
      public_vars.$sidebarMenu.hasClass("collapsed"))
  )
    return;
...
function stickFooterToBottom() {
  ...
  if (public_vars.$mainFooter.hasClass("sticky")) {
    ...
    if (
      win_height >
      main_content_height -
        parseInt(public_vars.$mainFooter.css("marginTop"), 10)
    ) {
...
function ps_update(destroy_init) {
  ...
  if (jQuery.isFunction(jQuery.fn.perfectScrollbar)) {
    ...
    public_vars.$sidebarMenu
      .find(".sidebar-menu-inner")
...
function ps_init() {
  ...
  if (jQuery.isFunction(jQuery.fn.perfectScrollbar)) {
    if (
      public_vars.$sidebarMenu.hasClass("collapsed") ||
      !public_vars.$sidebarMenu.hasClass("fixed")
    ) {
      return;
    }
